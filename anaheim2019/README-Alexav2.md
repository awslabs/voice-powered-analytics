...
1. Check your **AWS region** is N. Virginia (us-east-1)), since the Lambda function needs to be in the same region that your previous resources created in Module 2 were created.
...
**If time, try going back to [Module 0](https://github.com/awslabs/voice-powered-analytics/tree/master/anaheim2019) and deploying a custom data lake with your own twitter filter**
